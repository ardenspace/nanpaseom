...
- 세이브 코드 회전 + redeem 시도 제한 + 보유 신호(`has_save_code`)와 그 위의 발급 넛지 / 대체 확인 탈출구 — 계정 없는 신원 모델의 자격증명 위생과 복구 편의. 섬 안에서 일어나는 일이 아니라 *브라우저 바깥*의 이어하기 장치라 lore 대응물 없음 (ADR 0038–0040)
